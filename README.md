...
<img width="400" alt="image" src="./image/第一关1.png">

<img width="400" alt="image" src="./image/第一关2.png">
...
<img width="400" alt="image" src="./image/交叉测试1.png">

<img width="400" alt="image" src="./image/交叉测试2.jpg">

#### 第三关：拓展功能

考虑到向实用性扩展，加密算法的数据输入可以是ASII编码字符串(分组为1 Byte)，对应地输出也可以是ACII字符串(很可能是乱码)。

<img width="400" alt="image" src="./image/第三关1.png">

<img width="400" alt="image" src="./image/第三关2.png">

#### 第四关：暴力破解

假设你找到了使用相同密钥的明、密文对(一个或多个)，请尝试使用暴力破解的方法找到正确的密钥Key。在编写程序时，你也可以考虑使用多线程的方式提升破解的效率。请设定时间戳，用视频或动图展示你在多长时间内完成了暴力破解。

<img width="400" alt="image" src="./image/第四关.png">

#### 第五关：封闭测试

<img width="400" alt="image" src="./image/第五关1.png">

<img width="400" alt="image" src="./image/第五关2.png">

<img width="400" alt="image" src="./image/第五关3.png">

我们比较可以发现，我们对明文加密所使用的密钥为1111111111，但是在破解的过程中，破解成功所使用的密钥为0010110101与我们使用的加密密钥不一致，所以，对于随机选择的明文密文对，不止存在一个密钥key。我们将破解所使用的密钥用于对相同明文进行加密，获得了相同的密文，所以，可以得出结论，对于给定的明文，会出现不同的密钥进行加密得到相同的密文的情况。
